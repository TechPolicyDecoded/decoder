    ...
    jest.spyOn(fs, "readFileSync").mockReturnValue(
      JSON.stringify({
        ...
        top_donors_to_sponsors: [
          ...
          { name: "NaN Amount", amount: NaN, source_url: "https://fec.gov" },
          { name: "Infinite Amount", amount: Infinity, source_url: "https://fec.gov" },
          { name: "Negative Amount", amount: -100, source_url: "https://fec.gov" },
        ],
        lobbying_spend: [],
        sources: [],
      })
